...
public class PatchObject implements PatchOperation {
   ...
   */
  public PatchObject(OpEnum op, String path, Object value) {
      this.op = op;
      this.path = path;
      this.value = value;
  }
  ...
  public static class Builder {
    ...
    private PatchObject instance;

    public Builder() {
      this(new PatchObject());
    }

    protected Builder(PatchObject instance) {
      this.instance = instance;
    }

    protected Builder copyOf(PatchObject value) { 
    ...
    /**
    * returns a built PatchObject instance.
    *
    * The builder is not reusable (NullPointerException)
    */
    public PatchObject build() {
      try {
