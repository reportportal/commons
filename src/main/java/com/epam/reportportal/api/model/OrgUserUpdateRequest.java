...
public class OrgUserUpdateRequest extends UserOrgRole {
   ...
   */
  public OrgUserUpdateRequest(List<UserProjectInfo> projects, OrgRoleEnum orgRole) {
      super(orgRole);
  ...
  public static class Builder extends UserOrgRole.Builder {
    ...
    private OrgUserUpdateRequest instance;

    public Builder() {
      this(new OrgUserUpdateRequest());
    }

    protected Builder(OrgUserUpdateRequest instance) {
      super(instance); // the parent builder shares the same instance
      this.instance = instance;
    }

    protected Builder copyOf(OrgUserUpdateRequest value) { 
    ...
    /**
    * returns a built OrgUserUpdateRequest instance.
    *
    * The builder is not reusable (NullPointerException)
    */
    public OrgUserUpdateRequest build() {
      try {
